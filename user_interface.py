...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.title_target_lay = QtWidgets.QHBoxLayout()
        self.title_target_lay.setObjectName("title_target_lay")
        self.scan_target_label = QtWidgets.QLabel(parent=self.centralwidget)
        self.scan_target_label.setObjectName("scan_target_label")
        self.title_target_lay.addWidget(self.scan_target_label)
        self.scan_target_field = QtWidgets.QTextEdit(parent=self.centralwidget)
        self.scan_target_field.setMaximumSize(QtCore.QSize(16777215, 30))
        self.scan_target_field.setObjectName("scan_target_field")
        self.title_target_lay.addWidget(self.scan_target_field)
        self.general_lay.addLayout(self.title_target_lay)
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 774, 342))
        ...
        self.general_lay.setStretch(2, 3)
        self.general_lay.setStretch(3, 7)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.scan_target_label.setText(_translate("MainWindow", "Scan Target:"))
